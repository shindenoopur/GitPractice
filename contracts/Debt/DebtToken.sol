 ...
 */
contract DebtToken is ERC721Full, Pausable, PermissionEvents, Ownable {
    ...
    /**
     * We override approval method of the parent ERC721Full
    ...
    /**
     * We override setApprovalForAll method of the parent ERC721Full
     * contract to allow its functionality to be frozen in the case of an emergency
     */
    ...
    /**
     * We override transferFrom methods of the parent ERC721Full
     * contract to allow its functionality to be frozen in the case of an emergency
     */
    ...
    /**
     * We override safeTransferFrom methods of the parent ERC721Full
     * contract to allow its functionality to be frozen in the case of an emergency
     */
